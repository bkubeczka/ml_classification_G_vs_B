...
logging_module_name = "003_main_model_logistic_regression"
logging_level = logging.DEBUG

logger = log.getLogger(logging_module_name, logging_level)

log.print_phase(logger, "003. MODELE REGRESSION LOGISTIQUE")
...
# %%
# ================================
# MODELE : Régression Logistique avec GSCV
# ================================
#
...
columns_to_drop = ['REGION_', 'CSP_N1_', 'ACTIVITY_L1_', 'HOUSEHOLD_L1_'] # BKU : préciser les colonnes à retirer pour cause de redondance
...
# Scores
# ------
logger.info(f'score sur X_train: {accuracy_score(y_train, optimised_LR.predict(X_train))}')
logger.info("")  
...
# ---------------------------
logger.info("003_main_fitted_logistic_regression.joblib")
dump(optimised_LR, f"{cst.MODELS_DIR}/003_main_fitted_logistic_regression.joblib")
logger.info("")
